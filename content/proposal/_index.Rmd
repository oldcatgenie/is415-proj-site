...
Our team aims to propose and complete a project which will allow economists and policymakers to identify and better understand the spatial point patterns of various business entities in Singapore. By making use of such geospatial analysis techniques, they will be better at isolating specific points or areas with a specific spatial event distribution that they need in order to conduct further economic analysis, either for research or for government planning purposes.
...
- To conduct statistical simulations to reveal evidence of clusters or spatial autocorrelation.
...
We expect our lack of domain knowledge in the relationship between economics and geospatial analytics to hinder our interpretation of the analysis results. Further studies in this area may be required.
...
Statistical Society B25, 294.

Diggle, P.J., Chetwynd, A.G. (1991), Second-order analysis of spatial clustering for inhomo-
geneous populations, Biometrics 47, 1155-1163.
