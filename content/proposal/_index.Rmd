---
description: "Identifying Potential Clusters of Businesses by Type through Spatial Point Patterns Analysis and Geographic Segmentation"
draft: FALSE
title: "Proposal"
---
...
<table class="bordered">
  ...
  <tr>
  <td>Master Plan 2014 Subzone Boundary (No Sea)</td>
  <td>This dataset contains the spatial data, as the URA divides Singapore into regions, planning areas and subzones to facilitate urban planning.</td>
  <td>https://data.gov.sg/dataset/master-plan-2014-subzone-boundary-no-sea</td>
  <td>.shp Files</td>
  </tr>
</table>
...
This following series of photos is a storyboard which shows how the R Shiny Application will look like as the team develops it.

<p align="center">
![](/proposal/_index_files/Storyboard1.PNG)
</p>

The storyboard above shows the homepage of the R Shiny Application, where we list out all the pages of the Application and reintroduce the LandMarkdown project and its objectives.

<p align="center">
![](/proposal/_index_files/Storyboard2.PNG)
</p>

The second storyboard shows the data we used for our project in tabular format. This interactive table also allows simple searching and sorting.

<p align="center">
![](/proposal/_index_files/Storyboard3.PNG)
</p>

The third storyboard shows the results of our data exploration, where you can view the boxmaps, histograms and correlation plots. You can view these visualisations while selecting or filtering the industry category, among other options.

<p align="center">
![](/proposal/_index_files/Storyboard4.PNG)
</p>

The fourth storyboard shows the results of our spatial point pattern analysis, such as our Kernel Density maps as well as our owin and raster objects.

<p align="center">
![](/proposal/_index_files/Storyboard5.PNG)
</p>

The final storyboard shows the results of our geographic segmentation, where you can choose a variety of options such as:
...
Based on the above options chosen, you are then able to view a cluster map, a dendrogram, and a heatmap.
